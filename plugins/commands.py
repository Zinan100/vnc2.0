...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, SOURCE_TXT,  MAX_B_TN, IS_VERIFY, HOW_TO_VERIFY
...
@Client.on_message(filters.command('indexes'))
async def index_info(bot, message):
